...
const ReceiptEditor = ({ roomId, uploadData, onSuccess, onCancel }) => {
  ...
  const [receiptData, setReceiptData] = useState<ReceiptFormState>({
  ...
  const calculateTotal = (items: ReceiptItemForm[]) => {
                ...
                <div className="sm:col-span-2">
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      if (value === '' || (!Number.isNaN(Number.parseInt(value, 10)) && Number.parseInt(value, 10) >= 1)) {
