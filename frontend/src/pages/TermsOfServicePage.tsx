      ...
      <div className="bg-white shadow-sm">
        <div className="max-w-4xl mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-2xl font-bold text-neutral-900">{t('termsPage.title')}</h1>
            <div className="w-16" />
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
          <div className="flex items-center mb-4">
            ...
            <h2 className="text-xl font-semibold text-neutral-900">{t('termsPage.subtitle')}</h2>
          </div>
          <p className="text-sm text-neutral-600">{t('termsPage.updatedAt')}</p>
          <p className="text-sm text-neutral-600">{t('termsPage.scope')}</p>
        </div>
